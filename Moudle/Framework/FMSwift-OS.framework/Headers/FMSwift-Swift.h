...
SWIFT_CLASS("_TtC7FMSwift11DFUFirmware")
...
SWIFT_CLASS("_TtC7FMSwift15DFUFirmwareSize")
...
SWIFT_CLASS("_TtC7FMSwift21DFUPeripheralSelector")
...
SWIFT_PROTOCOL("_TtP7FMSwift19DFUProgressDelegate_")
...
SWIFT_CLASS("_TtC7FMSwift20DFUServiceController")
...
SWIFT_PROTOCOL("_TtP7FMSwift18DFUServiceDelegate_")
...
SWIFT_CLASS("_TtC7FMSwift19DFUServiceInitiator")
...
SWIFT_CLASS("_TtC7FMSwift6GLTest")
@interface GLTest : NSObject
- (void)disp;
...
SWIFT_CLASS("_TtC7FMSwift26LegacyDFUServiceController")
...
SWIFT_CLASS("_TtC7FMSwift25LegacyDFUServiceInitiator")
...
/// The Logger delegate.
SWIFT_PROTOCOL("_TtP7FMSwift14LoggerDelegate_")
@protocol LoggerDelegate
...
@interface NSData (SWIFT_EXTENSION(FMSwift))
@end



/// A controller object used to pause, resume or abort the DFU operation. Check methods documentation for more information.
SWIFT_CLASS("_TtC7FMSwift26SecureDFUServiceController")
...
/// The DFUServiceInitiator object should be used to send a firmware update to a remote BLE target compatible with the Nordic Semiconductor's DFU (Device Firmware Update). A delegate and logger may be specified to be informed about the status.
SWIFT_CLASS("_TtC7FMSwift25SecureDFUServiceInitiator")
...
typedef SWIFT_ENUM(NSInteger, State) {
  ...
  StateCompleted = 6,
  StateAborted = 7,
  StateSignatureMismatch = 8,
  StateOperationNotPermitted = 9,
  StateFailed = 10,
};
