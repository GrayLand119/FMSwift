...
extern unzFile unzOpen2 OF((const char *path, zlib_filefunc_def* pzlib_filefunc_def));
/* Open a Zip file, like unzOpen, but provide a set of file low level API for read/write operations */
extern unzFile unzOpen2_64 OF((const void *path, zlib_filefunc64_def* pzlib_filefunc_def));
...
extern int unzGetGlobalInfo OF((unzFile file, unz_global_info *pglobal_info));
extern int unzGetGlobalInfo64 OF((unzFile file, unz_global_info64 *pglobal_info));
/* Write info about the ZipFile in the *pglobal_info structure.

   return UNZ_OK if no error */

extern int unzGetGlobalComment OF((unzFile file, char *comment, uLong comment_size));
...
extern int unzOpenCurrentFilePassword OF((unzFile file, const char* password));
/* Open for reading data the current file in the zipfile.
   password is a crypting password

   return UNZ_OK if no error */

extern int unzOpenCurrentFile2 OF((unzFile file, int* method, int* level, int raw));
...
extern int unzOpenCurrentFile3 OF((unzFile file, int* method, int* level, int raw, const char* password));
/* Same as unzOpenCurrentFile, but takes extra parameter password for encrypted files */

extern int unzReadCurrentFile OF((unzFile file, voidp buf, unsigned len));
...
extern int unzGetCurrentFileInfo OF((unzFile file, unz_file_info *pfile_info, char *filename, 
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
extern int unzGetCurrentFileInfo64 OF((unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
...
extern int unzGetLocalExtrafield OF((unzFile file, voidp buf, unsigned len));
...
extern int unzGoToFirstFile2 OF((unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
...
extern int unzGoToNextFile2 OF((unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
...
extern int unzLocateFile OF((unzFile file, const char *filename, unzFileNameComparer filename_compare_func));
...
extern int unzGetFilePos OF((unzFile file, unz_file_pos* file_pos));
extern int unzGoToFilePos OF((unzFile file, unz_file_pos* file_pos));
...
extern int unzGetFilePos64 OF((unzFile file, unz64_file_pos* file_pos));
extern int unzGoToFilePos64 OF((unzFile file, const unz64_file_pos* file_pos));

extern uLong unzGetOffset OF((unzFile file));
extern ZPOS64_T unzGetOffset64 OF((unzFile file));
/* Get the current file offset */

extern int unzSetOffset OF((unzFile file, uLong pos));
extern int unzSetOffset64 OF((unzFile file, ZPOS64_T pos));
...
extern int unzseek OF((unzFile file, z_off_t offset, int origin));
extern int unzseek64 OF((unzFile file, ZPOS64_T offset, int origin));
