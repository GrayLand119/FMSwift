...
extern zipFile zipOpen4(const void *pathname, int append, ZPOS64_T disk_size, const char ** globalcomment,
...
extern zipFile zipOpen2_64(const void *pathname, int append, const char ** globalcomment,
...
extern zipFile zipOpen3(const char *pathname, int append, ZPOS64_T disk_size, const char ** globalcomment,
    zlib_filefunc_def* pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
...
extern zipFile zipOpen3_64(const void *pathname, int append, ZPOS64_T disk_size, const char ** globalcomment,
    zlib_filefunc64_def* pzlib_filefunc_def)
{
    if (pzlib_filefunc_def != NULL)
    {
